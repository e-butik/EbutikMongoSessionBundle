...
class AttributeBagNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        $bag = new FlashBag($data['storageKey']);
        $bag->setName($data['name']);
        $bag->initialize($data['flashes']);
    ...
    {
        return $data instanceof FlashBag;
    }
    ...
    {
        return $type == 'Symfony\Component\HttpFoundation\Session\Flash\FlashBag';
    }
}